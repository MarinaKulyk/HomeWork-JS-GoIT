...
//  вызова (callback). Функция mapArray создает новый массив 
//  numbers и заполняет его числами из массива array 
...
// которая принимает два параметра - element и index и возвращает
